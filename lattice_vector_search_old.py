...
def check(RealCoords, plane_vector):
    ...
    refined_peak = numpy.argmax(fourier[n_peak-2:n_peak+3]) + n_peak - 2
...
#    print(noise)
    ...
    logger.debug('Refined peak: {}'.format(refined_peak))
...
#DetectorPixel = 0.172
#os.chdir('/home/esrf/melnikov/spyder/test/LYS_dataset/')
#
